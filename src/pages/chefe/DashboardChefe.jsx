...
const DashboardChefe = () => {
  ...
  const fetchInstituicoes = useCallback(async () => {
    ...
    try {
      ...
      setError((e) => ({
        ...e,
        instituicoes:
          err.response?.data?.message ?? "Erro ao carregar instituições.",
      }));
    } finally {
  ...
  const filteredEstagios = estagios.filter(
    (e) =>
      !search ||
      (e.titulo ?? e.title ?? e.descricao ?? "")
        .toLowerCase()
  ...
  return (
    <div className={styles.dashboard}>
        ...
        <div className={styles.supportBox}>
          <div className={styles.supportContent}>
            ...
            <p className={styles.supportText}>
              Precisa de ajuda com o sistema? Contacte TI.
            </p>
          </div>
        </div>
        ...
        <main className={styles.content}>
                  ...
                  <div className={styles.promoCard}>
                    <div className={styles.promoContent}>
                      ...
                      <p className={styles.promoText}>
                        O relatório consolidado já está disponível para
                        exportação.
                      </p>
          ...
          {currentView === "users" && (
            <div className={styles.tableColumn}>
              ...
              {error.users && <p className={styles.errorMsg}>{error.users}</p>}
                    ...
                    {filteredUsers.length === 0 && !loading.users ? (
                      ...
                      filteredUsers.map((u) => (
                        <tr key={u.id}>
                          ...
                          <td>
                            <span
                              className={`${styles.badge} ${styles.badgeProfile}`}
                            >
                              {ROLE_LABELS[u.role ?? u.perfil] ??
                                u.role ??
                                u.perfil}
                            </span>
                          </td>
          ...
          {currentView === "instituicoes" && (
            <div className={styles.tableColumn}>
              ...
              <div className={styles.tableContainer}>
                ...
                <div className={styles.pagination}>
                  <span className={styles.paginationInfo}>
                    A mostrar {filteredInst.length} de {instituicoes.length}{" "}
                    instituições
                  </span>
                  <div className={styles.paginationControls}>
                    <button
          ...
          {currentView === "estagios" && (
            <div className={styles.tableColumn}>
              ...
              <div className={styles.tableContainer}>
                ...
                <div className={styles.pagination}>
                  <span className={styles.paginationInfo}>
                    A mostrar {filteredEstagios.length} de {estagios.length}{" "}
                    estágios
                  </span>
                  <div className={styles.paginationControls}>
                    <button
      ...
      {userModal && (
        <Modal
          title={
            userModal === "create" ? "Novo Utilizador" : "Editar Utilizador"
          }
        ...
        >
          ...
          <FormField
            label={
              userModal === "create"
                ? "Password"
                : "Nova Password (deixe em branco para manter)"
            }
          >
            <FormInput
              type="password"
          ...
          <FormField label="Instituição">
            <FormSelect
              ...
              onChange={(e) =>
                setUserForm((f) => ({ ...f, instituicao_id: e.target.value }))
              }
            >
      ...
      {instModal && (
        <Modal
          title={
            instModal === "create" ? "Nova Instituição" : "Editar Instituição"
          }
        ...
        >
          <FormField label="Nome">
            <FormInput
              value={instForm.nome}
              onChange={(e) =>
                setInstForm((f) => ({ ...f, nome: e.target.value }))
              }
              required
          ...
          <FormField label="Endereço">
            <FormInput
              ...
              onChange={(e) =>
                setInstForm((f) => ({ ...f, endereco: e.target.value }))
              }
          ...
          <FormField label="Telefone">
            <FormInput
              ...
              onChange={(e) =>
                setInstForm((f) => ({ ...f, telefone: e.target.value }))
              }
          ...
          <FormField label="Ponto Focal (Nome)">
            <FormInput
              ...
              onChange={(e) =>
                setInstForm((f) => ({ ...f, ponto_focal_nome: e.target.value }))
              }
